export const appointments = [
    {
      ...
      startDate: new Date(2022, 5, 22, 10, 0),
      endDate: new Date(2022, 5, 22, 11, 0),
      id: 3,
      location: 'Room 2',
    }, {
      title: 'Final Budget Review',
      startDate: new Date(2022, 5, 23, 12, 0),
      endDate: new Date(2022, 5, 23, 13, 35),
      id: 4,
      location: 'Room 2',
    }, {
      title: 'New Brochures',
      startDate: new Date(2022, 5, 20, 14, 30),
      endDate: new Date(2022, 5, 20, 15, 45),
      id: 5,
      location: 'Room 2',
    }, {
      ...
      title: 'Website Re-Design Plan',
      startDate: new Date(2022, 6, 21, 9, 30),
      endDate: new Date(2022, 6, 21, 15, 30),
      id: 16,
      location: 'Room 1',
    }, {
      title: 'Book Flights to San Fran for Sales Trip',
      ...
      title: 'Install New Router in Dev Room',
      startDate: new Date(2022, 6, 22, 14, 30),
      endDate: new Date(2022, 6, 22, 17, 30),
      id: 18,
      location: 'Room 2',
    }, {
      title: 'Approve Personal Computer Upgrade Plan',
      startDate: new Date(2022, 6, 22, 16, 0),
      endDate: new Date(2022, 6, 32, 9, 0),
      id: 19,
      location: 'Room 2',
    }, {
      title: 'Final Budget Review',
      startDate: new Date(2022, 6, 24, 10, 15),
      endDate: new Date(2022, 6, 25, 13, 35),
      id: 20,
      location: 'Room 1',
    }, {
      title: 'New Brochures',
      startDate: new Date(2022, 6, 21, 14, 30),
      endDate: new Date(2022, 6, 22, 15, 45),
      id: 21,
      location: 'Room 3',
    }, {
      title: 'Install New Database',
      ...
      startDate: new Date(2022, 6, 21, 10, 0),
      endDate: new Date(2022, 6, 22, 14, 30),
      id: 38,
      location: 'Room 2',
    }, {
      title: 'Customer Workshop',
